 ...
 */
public class NumberPicker extends DialogPreference {

    android.widget.NumberPicker np;
    private int mNewValue;
    private int mCurrentValue;
    private int DEFAULT_VALUE = Integer.valueOf(getContext().getResources().getString(R.string.speedReadDefaultValue));
